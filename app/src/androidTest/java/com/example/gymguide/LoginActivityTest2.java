...
public class LoginActivityTest2 {
    ...
    public void loginActivityTest2() {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.etEmail),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("bnewbs28@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(R.id.textViewUserName), withText("bnewbs28"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        textView2.check(matches(withText("bnewbs28")));
